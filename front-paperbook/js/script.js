...
btncadastrar.onclick = ()=>{
    ...
    if(btncadastrar.value=="Atualizar"){
        fetch("http://10.26.45.37:5000/api/v1/categoria/atualizar/"+idcat, {
        method:"PUT",
        headers:{
    ...
    fetch("http://10.26.45.37:5000/api/v1/categoria/cadastrar", {
        method:"POST",
        headers:{
            "accept":"application/json",
            "content-type":"application/json"
...
function exibirCategorias(){
    let saida = "";
    fetch("http://10.26.45.37:5000/api/v1/categoria/listar")
    .then((response)=>response.json())
    .then((dados)=>{
        dados.map((itens,ix)=>{
...
function apagar(id){
    fetch("http://10.26.45.37:5000/api/v1/categoria/apagar/"+id,{method:"DELETE"})
    .then((response)=>response.json())
    .then((dados)=>{
